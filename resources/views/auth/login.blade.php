                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block bg-login-image" id="restaurantlogo">
                            <img src="{{ asset('assets/img/logo.png')}}" class="loginlogo" alt="">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="InputPassword" placeholder="Password" name="password" value="">
                                        @error('password')
                                            <span class="invalid-feedback" role="alert"  style="display: block;">
                                                <strong>{{ $message }}</strong>
                                            </span>
