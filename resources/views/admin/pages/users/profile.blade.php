...
<!-- BEGIN PAGE LEVEL STYLES -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/assets/css/users/user-profile.css')}}">
    <style type="text/css">
            ...
            <div class="user-profile layout-spacing">
                <div class="widget-content widget-content-area">
                    ...
                    <div class="text-center user-info">
                        <img src="{{ asset('/images/') }}/{{ auth()->user()->image }}" height="150px" width="150px" alt="avatar">
                        ...
                        <div class="">
                            <ul class="contacts-block list-unstyled">
                                <li class="contacts-block__item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-coffee"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg> {{ auth()->user()->designation }}
                                </li>
                                <li class="contacts-block__item">
